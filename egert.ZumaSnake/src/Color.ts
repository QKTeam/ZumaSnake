class Color {
     ...
     */
    private OriginColor: number[] = 
    [0x7B1FA2, 0xB71C1C, 0x1976D2, 0x2E7D32, 0xFBC02D, 0x00897B, 0xF4511E];

    private BrightColor: number[] =
    [0x9C27B0, 0xD32F2F, 0x2196F3, 0x43A047, 0xFFEB3B, 0x26A69A, 0xFF7043];
